...
def modify_embed(filepath):
    ...
    # 4. Update the text in progress modal for "Auto Generate" when progress is near 99%
    # We will search for: <span x-text="progress + '%'"></span>
    # And add a conditional text below it.
    ...
    with open(filepath, 'w') as f:
        f.write(content)
    print("Modified embed!")

modify_embed('resources/views/embed/chatbot.blade.php')
