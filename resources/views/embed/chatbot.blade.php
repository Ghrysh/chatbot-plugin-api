                                        ...
                                        <div class="w-full text-center pointer-events-none flex flex-col items-center">
                                            ...
                                            <template x-if="!fileName">
                                                <div class="flex flex-col items-center w-full py-4">
                                                    <svg class="mx-auto h-12 w-12 text-slate-400 flex-shrink-0" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                    <div class="flex text-sm text-slate-600 justify-center mt-3">
                                                        <span class="font-medium text-indigo-600">Klik untuk pilih file atau Drag & Drop</span>
                                                    </div>
                                                    <p class="text-xs text-slate-500 mt-1">PDF, DOCX hingga 5MB. AI mengekstrak otomatis.</p>
                                                </div>
                                            </template>

                                            <!-- SUCCESS STATE -->
                                            <template x-if="fileName">
                                                <div class="flex flex-col items-center bg-emerald-50 rounded-xl p-4 border border-emerald-200 w-full transition-all">
                                                    <div class="bg-emerald-100 p-2 rounded-full mb-2">
                                                        <svg class="w-8 h-8 text-emerald-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                                    </div>
                                                    <p class="text-sm font-bold text-emerald-800">File Berhasil Dipilih!</p>
                                                    <p class="text-xs font-bold text-emerald-600 mt-1 truncate w-full max-w-[250px]" x-text="fileName"></p>
                                                    <p class="text-[10px] text-slate-500 mt-2">Klik lagi jika ingin mengganti file</p>
                                                </div>
                                            </template>
